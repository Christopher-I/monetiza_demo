...
const SendTipsModal = ({ isOpen, onClose, data }) => {
  ...
  const handleBitcoinPayment = async () => {
    ...
    if (selectedCard === "bitcoin" && Number(amount) < 20) {
      return toast.error("The minimum Bitcoin tips is $20");
    }
  ...
  return (
    <ModalWrapper isOpen={isOpen} onClose={onClose}>
      <div className="p-4 font-montserrat">
        <div className="text-2xl my-2 font-semibold">Tip Creator</div>
        ...
        <div className="font-semibold my-4">Tip Amount</div>
